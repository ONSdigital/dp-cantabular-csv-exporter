...
// 			HandleFunc: func(contextMoqParam context.Context, instanceComplete *event.InstanceComplete) error {
...
func (mock *HandlerMock) Handle(contextMoqParam context.Context, instanceComplete *event.InstanceComplete) error {
	...
	return mock.HandleFunc(contextMoqParam, instanceComplete)
}
