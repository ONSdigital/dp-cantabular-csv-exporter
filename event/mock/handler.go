...
func (mock *HandlerMock) Handle(ctx context.Context, cfg *config.Config, instanceComplete *event.InstanceComplete) error {
	...
	return mock.HandleFunc(ctx, cfg, instanceComplete)
}
